...
{
    internal sealed class FsmManager : KuusouEngineBasicModule, IFsmManager
    {
        ...
        internal override void Update(float elapseFrequency, float elapseFrequencyReally)
        {
            ...
            foreach (FsmBase fsm in _tempFsms)
            {
                ...
                fsm.Update(elapseFrequency, elapseFrequencyReally);
            }
        }
        ...
        public bool HasFsm(Type ownerType)
        {
            if (ownerType == null)
            {
                throw new KuusouEngineException("Owner type is invalid.");
            }
        ...
        public IFsm<T> CreateFsm<T>(string name, T owner, params FsmState<T>[] states) where T : class
        {
            ...
            if (HasFsm<T>(name))
            {
                throw new KuusouEngineException($"Already exist Fsm '{typeNamePair}'");
            }
